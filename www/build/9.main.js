...
var CreateCookData = (function () {
    function CreateCookData(http, navCtrl, transfer, alertCtrl, navParams, camera, actionSheetCtrl, WorkService, UserService) {
        this.http = http;
    ...
    CreateCookData.prototype.postdata = function () {
        var _this = this;
        this.UserService.presentLoadingDefault();
        var url = "http://www.devonhello.com/chihu/send_article";
    ...
    //删除提示
    CreateCookData.prototype.showConfirm = function (idx) {
        var _this = this;
    ...
    CreateCookData.prototype.up = function (path) {
        var _this = this;
        this.UserService.presentLoadingDefault();
...
CreateCookData = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_transfer__["a" /* Transfer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__["a" /* Camera */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_3__service_work_service__["a" /* WorkService */], __WEBPACK_IMPORTED_MODULE_4__service_user_service__["a" /* UserService */]])
], CreateCookData);
