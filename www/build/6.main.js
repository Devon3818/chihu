...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_file_opener__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_transfer__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file__ = __webpack_require__(370);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_opener__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_transfer__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(370);
...
var Setting = (function () {
    function Setting(fileOpener, transfer, http, navCtrl, navParams, UserService, alertCtrl, file) {
    ...
    Setting.prototype.out = function () {
        this.UserService.clearStorage();
        this.navCtrl.pop();
    };
    //app版本获取
    Setting.prototype.getAppVersion = function () {
        var _this = this;
        ...
        this.http.post(url, "", {
            ...
            if (res.json()[0]["v"] != _this.UserService.Version) {
                ...
                _this.UserService.showAlert("已经是最新版了...");
            }
        });
    };
    //下载最新版本
    Setting.prototype.download = function () {
        var _this = this;
        var _that = this;
    ...
    Setting.prototype.AppV = function () {
        var _this = this;
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        _this.download();
                        _this.UserService.showAlert("新版吃乎正在后台下载中...稍后安装");
                    }
                }
            ]
        });
